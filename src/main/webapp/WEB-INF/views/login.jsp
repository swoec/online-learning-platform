...
<base href="<%=basePath%>">
<meta charset="utf-8"/>
<title>Login to online learning platform</title>
...
<div class="content">
	...
	<form class="login-form" action="rest/user/login" method="post">
		...
		<div class="forget-password">
			...
			<p>click <a href="javascript:;" id="forget-password">here</a> reset your password.
			</p>
		</div>
		<div class="create-account">
			<p>
				 no account ?&nbsp; <a href="javascript:;" id="register-btn">create one</a>
			</p>
		</div>
	</form>
	<!-- END LOGIN FORM -->
	...
	<form class="register-form" action="index.html" method="post">
		...
		<div class="form-group">
			...
			<div class="controls">
				<div class="input-icon">
					<i class="fa fa-check"></i>
					<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="confirmation password" name="rpassword"/>
				</div>
			</div>
		</div>
		<div class="form-group">
			<label>
			<input type="checkbox" name="tnc"/> I agree <a href="#">service condition</a> 和 <a href="#">privacy policy</a>
			</label>
