...
<body ng-app="ngapp"
				...
				<div class="panel-body">
					<div class="thumbnail pull-center com" ng-repeat="com in coms">
						...
						<div class="caption">
							   ...
							   <h3 id="test" class="test"><span class="glyphicon glyphicon-headphones"></span>{{com.word}}</h3>
							   <div style="float:left"> <video ng-src="{{videoUrlFun(com.pic)}}" controls width="620" height="340"></video></div>
							   <div><li class="text-info">{{com.exp}}</li></div>
							
							
							
						   
						    
						    <li class="text-info"><input type="text" name="comment" style="width:620px;"></li>
							
							<p>
								<a href="#" align="right" class="btn btn-primary" role="button"
									ng-click="addToCart(com.id)">comments </a>
							</p>
	...
	<script type="text/javascript">
		...
		var ajaxModule = {
				...
				$.post("<%=basePath%>rest/word/videolist", cb);
			},
