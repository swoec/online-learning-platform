...
<body ng-app="ngapp"
				...
				<div class="panel-body">
					<div class="thumbnail pull-center com" ng-repeat="com in coms">
						...
						<div class="caption">
							   ...
							   <h3 id="test" class="test"><span class="glyphicon glyphicon-fire"></span>{{com.sname}}</h3>
							   <div style="float:left"><li class="text-info">{{com.sdesc}}&#8194;&#8194;</li> </div>
							   <div><li class="text-info">{{com.tags}}</li>
							   <p>
								<a href="#" align="right" class="btn btn-primary" role="button"
									ng-click="addToCart(com.id)">connect </a>
							   </p>
							   </div>
	...
	<script type="text/javascript">
		...
		var ajaxModule = {
				...
				$.post("<%=basePath%>rest/user/studentlist", cb);
			},
