...
@keyframes change{0%   {color:black;}25%{color:red;}50%{color:pink;}75%{color:#cf0;}100% {color:#f00;}}

#test1{animation:change 5s linear 0s infinite;font-size:13px;font-weight:100;font-family: Arial, Helvetica, sans-serif;}
@keyframes change{0%   {color:#333;}25%{color:#ff0;}50%{color:#f60;}75%{color:#cf0;}100% {color:#f00;}}
</style>

<body ng-app="ngapp" style="backgroud:black;">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="thumbnail pull-center com" ng-repeat="com in coms">
						...
						<div class="caption">
						 <h3 id="test" class="test"><span class="glyphicon glyphicon-briefcase"></span>{{com.bname}}</h3>
					       <div style="float:left"> <img ng-src="<%=basePath%>{{com.bpic}}" class="img-rounded" width="150"
							height="150" ></div>
					       <div id="test1"><li class="text-info"><font style="color:black;">{{com.bdesc}}</font></li></div>
							  
							
							
							<li class="text-info">{{com.blink}}</li>
							<li class="text-info"><span class="glyphicon glyphicon-download-alt"></span><a href="<%=basePath%>{{com.blocation}}" download="{{com.bname}}">download</a></li>
	...
	<script type="text/javascript">
		...
		var ajaxModule = {
				...
				$.post("<%=basePath%>rest/book/booklist", cb);
			},
			...
			getCommentById : function(id, cb) {
				$.post("<%=basePath%>word/comment/"+id, cb);
			},
			getWordById : function(id, cb) {
				$.post("<%=basePath%>word/word/"+id, cb);
			},
